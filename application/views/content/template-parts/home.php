						...
						foreach($infor_home as $value){
							...
							if($name_wg=='slider' and $value!=0){?>
								<div class="home-content" id="<?php echo $id_wg; ?>">
									<div class="col-lg-12 col-sm-12 col-xs-12 no-padding slider-home-gr">
										<?php
							...
							<?php }
							else if( ($name_wg=='sp_by_danhmucsanpham_sl') and $value!=0){//sp_by_danhmucsanpham
									...
									<div class="col-lg-12 col-md-12 col-xs-12 no-padding">
										<div class="container no-padding">
											<?php
												...
												// 	}
												// }
												$sp_by_danhmucsanpham_sl_type='';
												if($name_wg=='sp_by_danhmucsanpham_sl'){
													$sp_by_danhmucsanpham_sl_type='list-dmsp-home owl-carousel owl-theme owl-loaded owl-drag no-padding';
												}
											?>
											...
											<div class="list-sp-dmsp-home <?php echo $sp_by_danhmucsanpham_sl_type; ?>">
												<?php
													$data['id_dmsp']=$value;
													if($name_wg=='sp_by_danhmucsanpham_sl'){
														$this->load->view('content/template-parts/sanpham/wg_sp_by_dmsp_slider',$data);
													}else{
											...
											echo '<div class="home-content danhmucsanpham_home" id="'.$id_wg.'">
													<div class="col-lg-12 col-md-12 col-xs-12 no-padding">
														<div class="container no-padding">
															...
															<div class="list-dmsp-home owl-carousel owl-theme owl-loaded owl-drag no-padding">';
																$data['id_dmsp']=$value;
...
<?php $this->load->view( 'content/template-parts/popup' ); ?>
