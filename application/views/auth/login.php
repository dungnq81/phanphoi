...
<div class="modal-header">
	<h3 class="modal-title"><?php echo __( 'login_heading' ); ?></h3>
...
<div class="modal-body">
	...
	<?php echo form_open( "users/login?_action=login", [ 'id' => "login_form", 'class' => @$class ] ); ?>
	...
	<p class="reg">Bạn chưa có tài khoản? <a href="/users/register" title="Đăng ký thành viên">Đăng ký ngay</a></p>
	<?php echo form_close(); ?>
</div>
