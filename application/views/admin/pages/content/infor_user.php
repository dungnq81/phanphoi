<?php
	...
	if(isset($_GET['id'])){
		...
		$get_rows=$this->admin_model->select_table_dk_col_all('thanhvien','id="'.$_GET['id'].'" and typethanhvien!="admin" '); 

		$id_user=$_GET['id'];

	}else{

		$get_rows=$this->admin_model->select_table_dk_col_all('thanhvien','email="'.$_SESSION['user_admin'].'" and typethanhvien!="admin" '); 
					...
					<div class="box box-primary">
						...
						<div class="col-lg-6 col-md-6 col-xs-12 col-infor-details">
							...
							<form role="form" method="post" id="frm_infor_ad">
								...
								<div class="box-body">
									...
									<div class="form-group col-lg-6 col-md-6 col-xs-12">
										...
										<input type="text" class="form-control datetimepicker" placeholder="Vui lòng nhập ngày sinh" name="ngaysinh" value="<?php echo $ngaysinh; ?>" >	
							...
							<div class="box-footer">
								...
								<button type="submit" class="btn btn-primary btn_capnhat_infor_user" id="btn_capnhat_infor_user_<?php echo $id_user; ?>">Cập nhật</button>
						...
						<div class="col-lg-6 col-md-6 col-xs-12">
							...
							<div class="box-footer">
								...
								<button type="submit" class="btn btn-primary btn_capnhat_password_user" id="btn_capnhat_password_user_<?php echo $id_user; ?>">Cập nhật</button>
