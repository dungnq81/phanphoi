<?php
	...
	$infor_donhang=$this->admin_model->select_table_dk('donhang','id','="'.$_GET['id'].'" ');
	...
	foreach ($infor_donhang as $value) {
		...
		$email_kh=$vl_khachhang_ex[1];

		$sdt_kh=$vl_khachhang_ex[2];

		$khuvuc_kh=$vl_khachhang_ex[3].'-'.$vl_khachhang_ex[4];

		$diachi_kh=$vl_khachhang_ex[5];

		$ghichu_kh=$vl_khachhang_ex[6];
	...
	<section class="order-details">	
		        ...
		        <?php 
		        	...
		        	$count = 1;
		       	 	...
		       	 	foreach ($list_cart as $cart) { 
		       	 		...
		       	 		$gia_sp_have_baohanh=(int)$gia_sp+(int)$gia_goibaohanh;
	       			...
	       			<tr>
			            ...
			            <td><strong><?php echo number_format($cart['qty']*(int)$gia_sp); ?><span class="Price-currencySymbol">₫</span></strong></td>
		...
		<div class="col-lg-4 col-sm-4 col-xs-12 no-padding xuly-donhang">
			...
			<div class="box-footer">
				...
				<button type="submit" class="btn btn-primary" name="update_donhang">Cập nhật</button>
