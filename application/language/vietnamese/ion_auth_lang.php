...
// Account Creation
$lang['account_creation_successful']         = 'Đã khởi tạo tài khoản và kích hoạt thành công';
$lang['account_creation_email_activate']     = 'Tài khoản đã được tạo, vui lòng kiểm tra hộp thư để kích hoạt';
...
$lang['login_unsuccessful']            = 'Tên đăng nhập hoặc mật khẩu không đúng';
