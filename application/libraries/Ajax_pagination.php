...
class Ajax_pagination{
	...
	function create_links(){
		...
		if ($num_pages == 1){
            $info = '<span class="count_page">'.'Đang hiển thị : ' . $this->total_rows.'</span>';
			return $info;
		}
		...
		if(strlen(strstr($this->base_url, '/admin/phan-trang'))>0 || strlen(strstr($this->base_url, '/admin/danh-sach-tin-da-dang-phan-trang'))>0){
